...
export default function Timer() {
  ...
  return (
    <>
      <h2 className="text-purple-200 mt-12 font-black font-mono text-8xl">Pomodoro</h2>
      <div id="timer" className=" mt-20 md:mt-60 flex flex-col items-center ">
        ...
        <button
          className="opacity-70 text-xs md:text-xl transition-colors duration-300 mt-2 md:mt-4 bg-[#85b2f5] text-[#52302d] px-2 py-1 md:px-4 md:py-2 rounded-lg shadow hover:bg-[#a7a7df]"
